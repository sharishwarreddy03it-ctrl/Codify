...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const pyPercent =
    pyTotal > 0 ? Math.round((pyCompleted / pyTotal) * 100) : 0;
  ...
  const javaPercent =
    javaTotal > 0 ? Math.round((javaCompleted / javaTotal) * 100) : 0;
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-indigo-900 rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-2xl shadow-indigo-900/20 text-white">
            <div className="relative z-10">
              ...
              <p className="text-indigo-100/80 mb-6 max-w-md text-sm leading-relaxed">
                ...
                Complete today's lesson to maintain your {user?.streak || 1}
                -day streak and unlock new skills.
              </p>
            ...
            >
              ...
              <div className="flex items-end justify-between mb-2">
                ...
                <span className="text-xs text-red-400 font-medium">
                  {javaCompleted}/{javaTotal} Topics
                </span>
              </div>
          ...
          <div className="bg-[#1E293B] border border-slate-700 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 font-mono text-xs sm:text-sm leading-relaxed overflow-x-auto text-slate-300">
              <p>
                ...
                <span className="text-blue-400">is_prime</span>(n):
              </p>
              ...
              <p className="pl-4">
                ...
                n**<span className="text-orange-400">0.5</span>) +{' '}
                <span className="text-orange-400">1</span>):
              </p>

              <p className="pl-8">
                <span className="text-purple-400">if</span> n % i =={' '}
          ...
          <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-6 space-y-4">
            ...
            <div className="space-y-2.5">
              {LESSONS.slice(0, 4).map((lesson) => {
                const isCompleted =
                  progress[lesson.language].completedLessons.includes(
                    lesson.id
                  );
